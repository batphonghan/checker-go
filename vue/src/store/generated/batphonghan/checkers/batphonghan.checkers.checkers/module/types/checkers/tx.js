...
export class MsgClientImpl {
    ...
    RejectGame(request) {
        ...
        const promise = this.rpc.request('batphonghan.checkers.checkers.Msg', 'RejectGame', data);
        return promise.then((data) => MsgRejectGameResponse.decode(new Reader(data)));
    }
    PlayMove(request) {
        const data = MsgPlayMove.encode(request).finish();
        const promise = this.rpc.request('batphonghan.checkers.checkers.Msg', 'PlayMove', data);
        return promise.then((data) => MsgPlayMoveResponse.decode(new Reader(data)));
    }
    CreateGame(request) {
        const data = MsgCreateGame.encode(request).finish();
        const promise = this.rpc.request('batphonghan.checkers.checkers.Msg', 'CreateGame', data);
