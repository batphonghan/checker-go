...
export class QueryClientImpl {
    ...
    StoredGame(request) {
        ...
        const promise = this.rpc.request('batphonghan.checkers.checkers.Query', 'StoredGame', data);
    ...
    StoredGameAll(request) {
        ...
        const promise = this.rpc.request('batphonghan.checkers.checkers.Query', 'StoredGameAll', data);
    ...
    NextGame(request) {
        ...
        const promise = this.rpc.request('batphonghan.checkers.checkers.Query', 'NextGame', data);
